  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
      ...
      var firestoreProvider =
          Provider.of<FirestoreDataProviderMESSAGESforGROUPCHAT>(this.context, listen: false);
      ...
      Future.delayed(const Duration(milliseconds: 1700), () {
        ...
        currentpeer.setpeer(
            newgroupChatId: widget.groupID
                .replaceAll(RegExp('-'), '')
                .substring(1, widget.groupID.replaceAll(RegExp('-'), '').toString().length));
      });
    });
  }
      ...
      snapshot.docChanges.forEach((change) {
        if (change.type == DocumentChangeType.added) {
          ...
          if (chatprovider.checkIfDocAlreadyExits(
                  newDoc: updatedDoc, timestamp: updatedDoc[Dbkeys.timestamp]) ==
              true) {
          ...
          if (chatprovider.checkIfDocAlreadyExits(
                  newDoc: deletedDoc, timestamp: deletedDoc[Dbkeys.timestamp]) ==
              true) {
...
//       //----sharing intent action:
    ...
    if (index > widget.sharedFiles!.length) {
      ...
      await getFileData(File(widget.sharedFiles![index].path),
        ...
        if (imageUrl != null) {
          ...
          onSendMessage(context: this.context, content: finalUrl, type: type, timestamp: messagetime);
        }
      }).then((value) {
  ...
  setLastSeen(bool iswillpop, isemojikeyboardopen) {
    FirebaseFirestore.instance.collection(DbPaths.collectiongroups).doc(widget.groupID).update(
      {
  ...
  Future uploadFile(bool isthumbnail, {int? timestamp}) async {
    ...
    String fileName = getFileName(
        widget.groupID, isthumbnail == false ? '$uploadTimestamp' : '${thumnailtimestamp}Thumbnail');
    Reference reference =
        FirebaseStorage.instance.ref("+00_GROUP_MEDIA/${widget.groupID}/").child(fileName);
  ...
  Future uploadFileWithProgressIndicator(
    ...
    String fileName = getFileName(widget.currentUserno,
        isthumbnail == false ? '$uploadTimestamp' : '${thumnailtimestamp}Thumbnail');
    Reference reference =
        FirebaseStorage.instance.ref("+00_GROUP_MEDIA/${widget.groupID}/").child(fileName);
  ...
  void onSendMessage(
    ...
    final List<GroupModel> groupList = Provider.of<List<GroupModel>>(context, listen: false);
    // var chatprovider = Provider.of<FirestoreDataProviderMESSAGESforGROUPCHAT>(
    //     this.context,
    //     listen: false);
    Map<dynamic, dynamic> groupDoc =
        groupList.indexWhere((element) => element.docmap[Dbkeys.groupID] == widget.groupID) < 0
            ? {}
            : groupList.lastWhere((element) => element.docmap[Dbkeys.groupID] == widget.groupID).docmap;
        ...
        child: Row(
          children: <Widget>[
            Flexible(
              child: Container(
                ...
                decoration: BoxDecoration(
                    color: fiberchatWhite, borderRadius: BorderRadius.all(Radius.circular(30))),
                child: Row(
                  children: [
                    SizedBox(
                      width: 40,
            ...
            Container(
              ...
              decoration: BoxDecoration(
                  color: DESIGN_TYPE == Themetype.whatsapp ? multiboxMainColor : fiberchatLightGreen,
                  // border: Border.all(
              ...
              child: Padding(
                ...
                child: IconButton(
                  icon: new Icon(
                    textEditingController.text.isNotEmpty == true ? Icons.send : Icons.mic,
              ...
              child: Row(
                children: <Widget>[
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                        color:
                            DESIGN_TYPE == Themetype.whatsapp ? multiboxMainColor : fiberchatLightGreen,
                        // border: Border.all(
                        //   color: Colors.red[500],
                        // ),
                        borderRadius: BorderRadius.all(Radius.circular(30))),
            ...
            children: [
              Container(
                  ...
                  child: Row(children: [
                    Container(
                      decoration: BoxDecoration(
                        color: replyDoc![Dbkeys.groupmsgSENDBY] == widget.currentUserno
                            ? multiboxMainColor
                            : Colors.purple,
                      ...
                      child: Column(
                        ...
                        children: [
                          Padding(
                            ...
                            child: Text(
                              replyDoc![Dbkeys.groupmsgSENDBY] == widget.currentUserno
  ...
  buildEachMessage(Map<String, dynamic> doc, GroupModel groupData) {
      ...
      return Center(
        ...
        label: Text(
          doc[Dbkeys.groupmsgLISToptional].contains(widget.currentUserno) &&
              ...
              ? doc[Dbkeys.groupmsgLISToptional].contains(groupData.docmap[Dbkeys.groupCREATEDBY])
                  ? widget.currentUserno == groupData.docmap[Dbkeys.groupCREATEDBY]
              ...
              : doc[Dbkeys.groupmsgLISToptional].contains(widget.currentUserno) &&
                  ...
                  : !doc[Dbkeys.groupmsgLISToptional].contains(widget.currentUserno) &&
                          doc[Dbkeys.groupmsgLISToptional].length == 1
                      ? doc[Dbkeys.groupmsgSENDBY] == groupData.docmap[Dbkeys.groupCREATEDBY]
                          ? widget.currentUserno == groupData.docmap[Dbkeys.groupCREATEDBY]
    ...
    } else if (doc[Dbkeys.groupmsgTYPE] == Dbkeys.groupmsgTYPEnotificationCreatedGroup) {
      return Center(
          child: Chip(
        backgroundColor: Colors.blueGrey[50],
        label: Text(
    ...
    } else if (doc[Dbkeys.groupmsgTYPE] == Dbkeys.groupmsgTYPEnotificationUpdatedGroupDetails) {
      return Center(
          child: Chip(
        backgroundColor: Colors.blueGrey[50],
        label: Text(
    ...
    } else if (doc[Dbkeys.groupmsgTYPE] == Dbkeys.groupmsgTYPEnotificationUserSetAsAdmin) {
      return Center(
          child: Chip(
        backgroundColor: Colors.blueGrey[50],
        label: Text(
    ...
    } else if (doc[Dbkeys.groupmsgTYPE] == Dbkeys.groupmsgTYPEnotificationUserRemovedAsAdmin) {
      return Center(
          child: Chip(
        backgroundColor: Colors.blueGrey[50],
        label: Text(
    ...
    } else if (doc[Dbkeys.groupmsgTYPE] == Dbkeys.groupmsgTYPEnotificationUpdatedGroupicon) {
      return Center(
          child: Chip(
        backgroundColor: Colors.blueGrey[50],
        label: Text(
    ...
    } else if (doc[Dbkeys.groupmsgTYPE] == Dbkeys.groupmsgTYPEnotificationDeletedGroupicon) {
      return Center(
          child: Chip(
        backgroundColor: Colors.blueGrey[50],
        label: Text(
    ...
    } else if (doc[Dbkeys.groupmsgTYPE] == Dbkeys.groupmsgTYPEnotificationRemovedUser) {
      return Center(
          child: Chip(
        backgroundColor: Colors.blueGrey[50],
        label: Text(
    ...
    } else if (doc[Dbkeys.groupmsgTYPE] == Dbkeys.groupmsgTYPEnotificationUserLeft) {
      return Center(
          child: Chip(
        backgroundColor: Colors.blueGrey[50],
        label: Text(
  ...
  onDismiss(Map<String, dynamic> doc) {
    if ((doc[Dbkeys.content] == '' || doc[Dbkeys.content] == null) == false) {
      final contactsProvider = Provider.of<AvailableContactsProvider>(this.context, listen: false);
      setStateIfMounted(() {
        isReplyKeyboard = true;
        replyDoc = doc;
        messageReplyOwnerName = contactsProvider.joinedUserPhoneStringAsInServer
                    .indexWhere((element) => element.phone == doc[Dbkeys.groupmsgSENDBY]) >=
                0
            ? contactsProvider
                    .joinedUserPhoneStringAsInServer[contactsProvider.joinedUserPhoneStringAsInServer
                        .indexWhere((element) => element.phone == doc[Dbkeys.groupmsgSENDBY])]
                    .name ??
  ...
  contextMenu(BuildContext context, Map<String, dynamic> mssgDoc, {bool saved = false}) {
      ...
      tiles.add(ListTile(
          ...
          onTap: () async {
            ...
            if (mssgDoc[Dbkeys.messageType] == MessageType.image.index &&
              ...
              FirebaseStorage.instance.refFromURL(mssgDoc[Dbkeys.groupmsgCONTENT]).delete();
            } else if (mssgDoc[Dbkeys.messageType] == MessageType.doc.index) {
              FirebaseStorage.instance
                  .refFromURL(mssgDoc[Dbkeys.groupmsgCONTENT].split('-BREAK-')[0])
                  .delete();
              ...
              FirebaseStorage.instance
                  ...
                  .delete();
              FirebaseStorage.instance
                  .refFromURL(mssgDoc[Dbkeys.groupmsgCONTENT].split('-BREAK-')[1])
                  .delete();
            }
            ...
            FirebaseFirestore.instance
                ...
                .doc(widget.groupID)
                .collection(DbPaths.collectiongroupChats)
                .doc('${mssgDoc[Dbkeys.groupmsgTIME]}--${mssgDoc[Dbkeys.groupmsgSENDBY]}')
                .update({
        ...
        try {
          ...
          if (encrypted is String) {
            ...
            if (content.trim() != '') {
              ...
              if (targetPeer == null) {
                await ChatController.request(widget.currentUserno, list[tempSendIndex][Dbkeys.phone],
              ...
              await FirebaseFirestore.instance.collection(DbPaths.collectionmessages).doc(chatId).set({
                ...
                list[tempSendIndex][Dbkeys.phone]: list[tempSendIndex][Dbkeys.lastSeen],
                ...
                widget.model.addMessage(list[tempSendIndex][Dbkeys.phone], timestamp2, messaging);
              }).then((value) async {
                Future messaging = FirebaseFirestore.instance
        ...
        builder: (context, contactsProvider, _child) => InkWell(
              ...
              child: GroupChatBubble(
                ...
                savednameifavailable: contactsProvider.filtered!.entries
                            .toList()
                            .indexWhere((element) => element.key == doc[Dbkeys.groupmsgSENDBY]) >=
                        0
                ...
                child: doc[Dbkeys.groupmsgISDELETED] == true
                    ...
                    : doc[Dbkeys.messageType] == MessageType.text.index
                        ...
                        : doc[Dbkeys.messageType] == MessageType.location.index
                            ? getLocationMessage(doc[Dbkeys.content], doc, saved: false)
                            : doc[Dbkeys.messageType] == MessageType.doc.index
                                ? getDocmessage(context, doc[Dbkeys.content], doc, saved: false)
                                : doc[Dbkeys.messageType] == MessageType.audio.index
                                    ? getAudiomessage(context, doc[Dbkeys.content], doc,
                                        isMe: isMe, saved: false)
                                    : doc[Dbkeys.messageType] == MessageType.video.index
                                        ? getVideoMessage(context, doc[Dbkeys.content], doc,
                                            saved: false)
                                        : doc[Dbkeys.messageType] == MessageType.contact.index
                                            ? getContactMessage(context, doc[Dbkeys.content], doc,
                                                saved: false)
                                            : getImageMessage(
                                                doc,
                                                saved: saved,
  ...
  Widget getVideoMessage(BuildContext context, String message, Map<String, dynamic> doc,
      {bool saved = false}) {
  ...
  Widget getContactMessage(BuildContext context, String message, Map<String, dynamic> doc,
      {bool saved = false}) {
    final bool isMe = doc[Dbkeys.groupmsgSENDBY] == widget.currentUserno;
    return SizedBox(
      width: 210,
  ...
  Widget getLocationMessage(String? message, Map<String, dynamic> doc, {bool saved = false}) {
    final bool isMe = doc[Dbkeys.groupmsgSENDBY] == widget.currentUserno;
    return InkWell(
      onTap: () {
        launch(message!);
  ...
  Widget getAudiomessage(BuildContext context, String message, Map<String, dynamic> doc,
  ...
  Widget getDocmessage(BuildContext context, String message, Map<String, dynamic> doc,
      {bool saved = false}) {
    final bool isMe = doc[Dbkeys.groupmsgSENDBY] == widget.currentUserno;
    return SizedBox(
      width: 220,
                  ...
                  onTap: () => Navigator.push(
                      ...
                      MaterialPageRoute(
                        builder: (context) => PhotoViewWrapper(
                          ...
                          imageProvider: CachedNetworkImageProvider(doc[Dbkeys.content]),
                        ),
                      )),
                  child: CachedNetworkImage(
                    placeholder: (context, url) => Container(
                    ...
                    children: [
                      Container(
                          ...
                          child: Row(children: [
                            Container(
                              decoration: BoxDecoration(
                                color: doc[Dbkeys.groupmsgSENDBY] == widget.currentUserno
                                    ? multiboxMainColor
                                    : Colors.purple,
                                borderRadius: BorderRadius.only(
                                    topRight: Radius.circular(0),
                                ...
                                children: [
                                  Padding(
                                    ...
                                    child: Text(
                                      doc[Dbkeys.groupmsgSENDBY] == widget.currentUserno
                                          ? getTranslated(this.context, 'you')
                                          : contactsProvider.joinedUserPhoneStringAsInServer.indexWhere(
                                                      (element) =>
  ...
  Widget buildMessagesUsingProvider(BuildContext context) {
    return Consumer<List<GroupModel>>(
        builder: (context, groupList, _child) => Consumer<FirestoreDataProviderMESSAGESforGROUPCHAT>(
                          ...
                          onPressed: () {
                            ...
                            Navigator.push(
                              ...
                              if (url != null) {
                                ...
                                onSendMessage(
                                  context: this.context,
                                  content: url + '-BREAK-' + thumbnailurl + '-BREAK-' + videometadata,
                    ...
                    children: [
                      Scaffold(
                          ...
                          appBar: AppBar(
                            ...
                            backgroundColor:
                                DESIGN_TYPE == Themetype.whatsapp ? multiboxMainColor : fiberchatWhite,
                            title: InkWell(
                              onTap: () {
                                Navigator.push(
                                    context,
                                ...
                                children: [
                                  ...
                                  Column(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        getTranslated(context, 'tapherefrgrpinfo'),
                                        style: TextStyle(
                                            color: DESIGN_TYPE == Themetype.whatsapp
                                                ? fiberchatWhite
                                                : fiberchatGrey,
                              ...
                              Column(mainAxisAlignment: MainAxisAlignment.end, children: [
                                ...
                                groupList
                                    ...
                                    : Container(
                                        ...
                                        child: Text(
                                          getTranslated(context, 'onlyadminsend'),
                                          textAlign: TextAlign.center,
  ...
  Widget selectablelinkify(String? text, double? fontsize, TextAlign? textalign) {
    return SelectableLinkify(
      style:
          TextStyle(fontSize: fontsize, color: Colors.black87, height: 1.3, fontStyle: FontStyle.normal),
      text: text ?? "",
      textAlign: textalign,
      onOpen: (link) async {
