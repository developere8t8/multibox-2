...
class _GroupDetailsState extends State<GroupDetails> {
  ...
  userAction(
      value, String targetPhone, bool targetPhoneIsAdmin, List targetUserNotificationTokens) async {
              ...
              FlatButton(
                ...
                onPressed: () async {
                  ...
                  await FirebaseFirestore.instance
                      ...
                      .doc(widget.groupID)
                      .update({
                    Dbkeys.groupADMINLIST: FieldValue.arrayRemove([targetPhone]),
                  }).then((value) async {
                    ...
                    await FirebaseFirestore.instance
                        ...
                        .doc(time.millisecondsSinceEpoch.toString() + '--' + widget.currentUserno)
                        .set({
                      ...
                      Dbkeys.groupmsgTYPE: Dbkeys.groupmsgTYPEnotificationUserRemovedAsAdmin,
                    });
                    setStateIfMounted(() {
                      isloading = false;
                    });
                    ...
                    Fiberchat.toast('Failed to set as Admin ! \nError occured -$onError');
                  });
                },
              )
            ],
                ...
                onPressed: () async {
                  ...
                  await FirebaseFirestore.instance
                    ...
                    await FirebaseFirestore.instance
                      ...
                      Dbkeys.groupmsgSENDBY: widget.currentUserno,
                      Dbkeys.groupmsgISDELETED: false,
                      Dbkeys.groupmsgTYPE: Dbkeys.groupmsgTYPEnotificationUserSetAsAdmin,
                    });
                    setStateIfMounted(() {
                      isloading = false;
                    });
                ...
                onPressed: () async {
                  ...
                  await FirebaseFirestore.instance
                      ...
                      .update(targetPhoneIsAdmin == true
                          ? {
                              Dbkeys.groupMEMBERSLIST: FieldValue.arrayRemove([targetPhone]),
                              Dbkeys.groupADMINLIST: FieldValue.arrayRemove([targetPhone]),
                    ...
                    await FirebaseFirestore.instance
                        ...
                        .doc(time.millisecondsSinceEpoch.toString() + '--' + widget.currentUserno)
                        .set({
                      Dbkeys.groupmsgCONTENT: '$targetPhone ${getTranslated(context, 'removedbyadmin')}',
                      Dbkeys.groupmsgLISToptional: [
                        targetPhone,
                      ],
                      Dbkeys.groupmsgTIME: time.millisecondsSinceEpoch,
                      Dbkeys.groupmsgSENDBY: widget.currentUserno,
                      Dbkeys.groupmsgISDELETED: false,
                      Dbkeys.groupmsgTYPE: Dbkeys.groupmsgTYPEnotificationRemovedUser,
                    });
                    setStateIfMounted(() {
                      isloading = false;
                    });
                    ...
                    Fiberchat.toast('Failed to remove ! \nError occured -$onError');
                  });
                },
              )
            ],
  ...
  Widget build(BuildContext context) {
    ...
    return PickupLayout(scaffold:
        Fiberchat.getNTPWrappedWidget(Consumer<List<GroupModel>>(builder: (context, groupList, _child) {
      Map<dynamic, dynamic> groupDoc =
          groupList.indexWhere((element) => element.docmap[Dbkeys.groupID] == widget.groupID) < 0
              ? {}
              : groupList
                  .lastWhere((element) => element.docmap[Dbkeys.groupID] == widget.groupID)
                  .docmap;
                        ...
                        onPressed: () {
                          Navigator.push(
                              ...
                              new MaterialPageRoute(
                                  builder: (context) => new EditGroupDetails(
                                        prefs: widget.prefs,
                                        currentUserNo: widget.currentUserno,
                                        isadmin: groupDoc[Dbkeys.groupCREATEDBY] == widget.currentUserno,
                                        groupType: groupDoc[Dbkeys.groupTYPE],
                                        groupDesc: groupDoc[Dbkeys.groupDESCRIPTION],
                              ...
                              CachedNetworkImage(
                                ...
                                placeholder: (context, url) => Container(
                                  ...
                                  child: Icon(Icons.people,
                                      color: fiberchatGrey.withOpacity(0.5), size: 75),
                                ),
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                                ...
                                                Navigator.push(
                                                  ...
                                                  if (url != null) {
                                                    await FirebaseFirestore.instance
                                                        .collection(DbPaths.collectiongroups)
                                                        .doc(widget.groupID)
                                                        .update({Dbkeys.groupPHOTOURL: url}).then(
                                                            (value) async {
                                                      DateTime time = DateTime.now();
                                                      await FirebaseFirestore.instance
                                                          .collection(DbPaths.collectiongroups)
                                                          ...
                                                          .set({
                                                        Dbkeys.groupmsgCONTENT: groupDoc[
                                      ...
                                      groupDoc[Dbkeys.groupPHOTOURL] == null ||
                                              groupDoc[Dbkeys.groupCREATEDBY] != widget.currentUserno
                                          ? SizedBox()
                                              ...
                                              ? IconButton(
                                                  onPressed: () async {
                                                    ...
                                                    await FirebaseStorage.instance
                                                        .refFromURL(groupDoc[Dbkeys.groupPHOTOURL])
                                                        .delete()
                                                        .then((d) async {
                                                      await FirebaseFirestore.instance
                                                          .collection(DbPaths.collectiongroups)
                                                      ...
                                                      if (error.toString().contains(
                                                              Dbkeys.firebaseStorageNoObjectFound1) ||
                                                          error.toString().contains(
                                                              Dbkeys.firebaseStorageNoObjectFound2) ||
                                                          error.toString().contains(
                                                              Dbkeys.firebaseStorageNoObjectFound3) ||
                                                          error.toString().contains(
                                                              Dbkeys.firebaseStorageNoObjectFound4)) {
                                                        await FirebaseFirestore.instance
                                                            .collection(DbPaths.collectiongroups)
                                                            .doc(widget.groupID)
                                                            .update({
                                              ...
                                              Navigator.push(
                                                  ...
                                                  new MaterialPageRoute(
                                                      builder: (context) => new EditGroupDetails(
                                                            prefs: widget.prefs,
                                                            currentUserNo: widget.currentUserno,
                                                            isadmin: groupDoc[Dbkeys.groupCREATEDBY] ==
                                                                widget.currentUserno,
                                                            groupType: groupDoc[Dbkeys.groupTYPE],
                                                            groupDesc: groupDoc[Dbkeys.groupDESCRIPTION],
                                                            groupName: groupDoc[Dbkeys.groupNAME],
                          ...
                          Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(
                                  groupDoc[Dbkeys.groupTYPE] == Dbkeys.groupTYPEonlyadminmessageallowed
                                ...
                                Row(
                                  ...
                                  children: [
                                        ...
                                        children: [
                                          Text(
                                            '${groupList.firstWhere((element) => element.docmap[Dbkeys.groupID] == widget.groupID).docmap[Dbkeys.groupMEMBERSLIST].length}' +
                                                ' ' +
                                                getTranslated(context, 'participants'),
                                            textAlign: TextAlign.left,
                                            style: TextStyle(
                                                fontWeight: FontWeight.bold,
                                                color: multiboxMainColor,
                                    ...
                                    (groupDoc[Dbkeys.groupMEMBERSLIST].length >=
                                        ...
                                        : InkWell(
                                            onTap: () {
                                              final AvailableContactsProvider dbcontactsProvider =
                                                  Provider.of<AvailableContactsProvider>(context,
                                                      listen: false);
                                              dbcontactsProvider.fetchContacts(context, widget.model,
                                                  widget.currentUserno, widget.prefs);
                                              Navigator.push(
                                                  context,
                                                  MaterialPageRoute(
                                                      builder: (context) => AddContactsToGroup(
                                                            ...
                                                            prefs: widget.prefs,
                                                            groupID: widget.groupID,
                                                            isAddingWhileCreatingGroup: false,
                                                          )));
                                            },
                                            child: SizedBox(
                                              height: 50,
                                                ...
                                                children: [
                                                  SizedBox(
                                                    ...
                                                    child: Icon(Icons.add,
                                                        size: 19, color: fiberchatLightGreen),
                                                  ),
                                                  // Text(
                                              ...
                                              onPressed: () async {
                                                ...
                                                Future.delayed(const Duration(milliseconds: 300),
                                                  ...
                                                  await FirebaseFirestore.instance
                                                    ...
                                                    Dbkeys.groupIDfiltered:
                                                        '${widget.groupID.replaceAll(RegExp('-'), '').substring(1, widget.groupID.replaceAll(RegExp('-'), '').toString().length)}',
                                                    Dbkeys.notificationTokens: widget.model
                                                    ...
                                                    Fiberchat.toast(
                                                        getTranslated(context, 'unabletoleavegrp'));
                                                  });
                                                });
                                              },
                                            )
                ...
                return FutureBuilder<DocumentSnapshot>(
                    ...
                    builder: (context, AsyncSnapshot snapshot) {
                      if (snapshot.connectionState == ConnectionState.waiting) {
                                ...
                                ListTile(
                                  ...
                                  title: Text(
                                    availableContacts.filtered!.entries
                                                .toList()
                                                .indexWhere((element) => element.key == adminlist[i]) >
                                            0
                                        ? availableContacts.filtered!.entries
                                            .elementAt(availableContacts.filtered!.entries
                                                .toList()
                                                .indexWhere((element) => element.key == adminlist[i]))
                                            .value
                                            .toString()
                        ...
                        bool isListUserSuperAdmin = groupDoc[Dbkeys.groupCREATEDBY] == adminlist[i];
                        //----
                        bool islisttUserAdmin = groupDoc[Dbkeys.groupADMINLIST].contains(adminlist[i]);
                                ...
                                ListTile(
                                  trailing: SizedBox(
                                    ...
                                    child: (isCurrentUserSuperAdmin ||
                                            ((isCurrentUserAdmin && isListUserOnlyUser) == true))
                                        ? isListUserSuperAdmin
                                            ...
                                            : PopupMenuButton<String>(
                                                ...
                                                onSelected: (String value) {
                                                  userAction(value, adminlist[i], islisttUserAdmin,
                                                      snapshot.data[Dbkeys.notificationTokens] ?? []);
                                                },
                                                child: Icon(
                                  ...
                                  leading: Padding(
                                    ...
                                    child: Padding(
                                      padding: const EdgeInsets.all(0.0),
                                      child: snapshot.data[Dbkeys.photoUrl] == null
                                          ? Container(
                                              width: 40.0,
                                              height: 40.0,
                                          ...
                                          : CachedNetworkImage(
                                              imageUrl: snapshot.data[Dbkeys.photoUrl] ?? '',
                                              imageBuilder: (context, imageProvider) => Container(
                                                    width: 40.0,
                                                    height: 40.0,
                                                    decoration: BoxDecoration(
                                  ...
                                  onTap: widget.currentUserno == snapshot.data[Dbkeys.phone]
                                      ? () {}
                                      : () {
                                          Navigator.push(
                                              context,
                                    ...
                                    ? Positioned(
                                        ...
                                        child: Container(
                                          ...
                                          decoration: new BoxDecoration(
                                            color: Colors.white,
                                            border: new Border.all(
                                                color: adminlist[i] == groupDoc[Dbkeys.groupCREATEDBY]
                                                    ? Colors.purple[400]!
                                                    : Colors.green[400]!,
                                                width: 1.0),
                                            borderRadius: new BorderRadius.circular(5.0),
  ...
  getUsersList() {
    return Consumer<List<GroupModel>>(builder: (context, groupList, _child) {
      ...
      return Consumer<AvailableContactsProvider>(builder: (context, availableContacts, _child) {
              ...
              return FutureBuilder<DocumentSnapshot>(
                  ...
                  builder: (context, AsyncSnapshot snapshot) {
                    if (snapshot.connectionState == ConnectionState.waiting) {
                            ...
                            children: [
                              ListTile(
                                ...
                                title: Text(
                                  availableContacts.filtered!.entries
                                              .toList()
                                              .indexWhere((element) => element.key == viewerslist[i]) >
                                          0
                                      ? availableContacts.filtered!.entries
                                          .elementAt(availableContacts.filtered!.entries
                                              .toList()
                                  ...
                                  ? Positioned(
                                      ...
                                      child: Container(
                                        ...
                                        decoration: new BoxDecoration(
                                          color: Colors.white,
                                          border: new Border.all(
                                              color: Colors.green[400] ?? Colors.grey, width: 1.0),
                                          borderRadius: new BorderRadius.circular(5.0),
                                        ),
                                        child: new Center(
                                          child: new Text(
                                            getTranslated(context, 'admin'),
                                            style:
                                                new TextStyle(fontSize: 11.0, color: Colors.green[400]),
                                          ),
                                        ),
                                      ),
                                    )
                      ...
                      bool isListUserSuperAdmin = groupDoc[Dbkeys.groupCREATEDBY] == viewerslist[i];
                      //----
                      bool islisttUserAdmin = groupDoc[Dbkeys.groupADMINLIST].contains(viewerslist[i]);
                      bool isListUserOnlyUser =
                          !groupDoc[Dbkeys.groupADMINLIST].contains(viewerslist[i]);
                      return Column(
                        mainAxisSize: MainAxisSize.min,
                                  ...
                                  child: (isCurrentUserSuperAdmin ||
                                      ...
                                      ? isListUserSuperAdmin
                                          ...
                                          : PopupMenuButton<String>(
                                              ...
                                              onSelected: (String value) {
                                                userAction(value, viewerslist[i], islisttUserAdmin,
                                                    snapshot.data[Dbkeys.notificationTokens] ?? []);
                                              },
                                              child: Icon(
                                                Icons.more_vert_outlined,
                            ...
                            groupDoc[Dbkeys.groupADMINLIST].contains(viewerslist[i])
                                ? Positioned(
                                    ...
                                    child: Container(
                                      ...
                                      decoration: new BoxDecoration(
                                        color: Colors.white,
                                        border: new Border.all(color: Colors.green[400]!, width: 1.0),
                                        borderRadius: new BorderRadius.circular(5.0),
                                      ),
                                      child: new Center(
                                        child: new Text(
