              ...
              actions: <Widget>[
                TextButton(
                  ...
                  child: Text(
                    ...
                    style: TextStyle(
                      fontSize: 16,
                      color: DESIGN_TYPE == Themetype.whatsapp ? fiberchatWhite : multiboxMainColor,
                    ),
                  ),
                )
              ],
                  ...
                  child: Column(
                    children: <Widget>[
                            ...
                            children: <Widget>[
                              ...
                              Positioned(
                                  ...
                                  child: FloatingActionButton(
                                      ...
                                      child: Icon(Icons.camera_alt, color: fiberchatWhite),
                                      onPressed: () {
                                        Navigator.push(
                                            context,
                                            MaterialPageRoute(
                                          ...
                                          if (url != null) {
                                            ...
                                            FirebaseFirestore.instance
                                                ...
                                                .doc(phone)
                                                .update({Dbkeys.photoUrl: photoUrl}).then((data) async {
                      ...
                      ListTile(
                        ...
                        validator: (v) {
                          return v!.isEmpty ? getTranslated(this.context, 'validdetails') : null;
                        },
                        decoration: InputDecoration(
                            contentPadding: EdgeInsets.all(6),
                            labelStyle: TextStyle(height: 0.8),
                            labelText: getTranslated(this.context, 'enter_fullname')),
                      )),
                      SizedBox(
                        height: 15,
                      ),
                      ...
                      ListTile(
                        ...
                        decoration: InputDecoration(
                            contentPadding: EdgeInsets.all(6),
                            labelStyle: TextStyle(height: 0.8),
                            labelText: getTranslated(this.context, 'enter_mobilenumber')),
                      )),
                    ],
                  ),
