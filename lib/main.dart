...
class FiberchatWrapper extends StatefulWidget {
  ...
  static void setLocale(BuildContext context, Locale newLocale) {
    _FiberchatWrapperState state = context.findAncestorStateOfType<_FiberchatWrapperState>()!;
...
class _FiberchatWrapperState extends State<FiberchatWrapper> {
  ...
  Widget build(BuildContext context) {
    ...
    final FirebaseBroadcastServices firebaseBroadcastServices = FirebaseBroadcastServices();
                      ...
                      return MultiProvider(
                        providers: [
                          ChangeNotifierProvider(
                              create: (_) => FirestoreDataProviderMESSAGESforBROADCASTCHATPAGE()),
                          //---
                          ChangeNotifierProvider(create: (_) => StatusProvider()),
                          ChangeNotifierProvider(
                              create: (_) => FirestoreDataProviderMESSAGESforGROUPCHAT()),
                          ...
                          ChangeNotifierProvider(create: (_) => FirestoreDataProviderCALLHISTORY()),
                          ChangeNotifierProvider(create: (_) => CurrentChatPeer()),
                        ],
                        child: StreamProvider<List<BroadcastModel>>(
                          initialData: [],
                          create: (BuildContext context) => firebaseBroadcastServices
                              .getBroadcastsList(snapshot.data!.getString(Dbkeys.phone) ?? ''),
                          child: StreamProvider<List<GroupModel>>(
                            ...
                            child: MaterialApp(
                              ...
                              theme: ThemeData(
                                  fontFamily: FONTFAMILY_NAME, indicatorColor: fiberchatLightGreen),
                              title: Appname,
